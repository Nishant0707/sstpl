...
const Youth = () => {
  ...
  return (
    <Box bg={bg} minH="100vh" px={{ base: 4, md: 20 }} py={14}>
      {/* HERO */}
      <VStack spacing={8} textAlign="center" mb={14} maxW="3xl" mx="auto">
        ...
        <Text fontSize={{ base: "lg", md: "xl" }} color={secondaryText} fontWeight="medium">
          At SSTPL, we champion the skills, dreams, and ambitions of India's youth. Whether you're discovering, upskilling, or connecting with opportunities, we shape futures through holistic support, quality assessments, and mentorship. Join a movement where learning leads to lasting success.
        </Text>
      ...
      <Box mb={14} maxW="6xl" mx="auto">
        ...
        <Text color={secondaryText} fontWeight="medium" maxW="4xl" mx="auto" textAlign="center">
          By focusing on youth skills and perspectives, SSTPL unlocks a workforce that's adaptive, innovative, and equipped to lead national progress in every domain.
        </Text>
      </Box>
      ...
      <Divider my={12} />
      <Box mb={14} maxW="6xl" mx="auto">
        <Heading fontSize="2xl" mb={6} color={textColor} fontWeight="bold">
          Success Stories
        </Heading>
      ...
      <Box textAlign="center" mt={4}>
        ...
        <Text color={secondaryText} mb={6} fontSize="md" maxW="xl" mx="auto">
