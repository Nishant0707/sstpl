...
import { FiEdit2, FiList, FiSettings, FiImage, FiBookOpen, FiMessageCircle } from "react-icons/fi";

// Example assessment types (with optional icons)
const items = [
  {
    icon: FiList,
...
// You can swap in replacement images/icons as needed.
...
export default function Sereduque() {
  ...
  return (
    <Box
      ...
      letterSpacing="tight"
    >
      <VStack maxW="1040px" mx="auto" spacing={5}>
        <Heading
          as="h1"
        ...
        <Text
          ...
          textAlign="center"
        >
          Discover the diverse question and assessment types that fuel modern learning, recruitment, and skill mapping across domains.
        </Text>
      </VStack>
