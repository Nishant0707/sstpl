...
import {
  ...
  AccordionIcon, Input, Textarea, Button, VStack, HStack, IconButton
    ...
    <Box p={8} bg="white" boxShadow="xl" borderRadius="lg" maxW="1000px" mx="auto">
      ...
      <Accordion allowMultiple>
        ...
        <AccordionItem>
          <h2>
            <AccordionButton>
              <Box flex="1" textAlign="left" fontWeight="bold">Hero Banner (4 Images)</Box>
              <AccordionIcon />
            </AccordionButton>
          </h2>
          <AccordionPanel>
            {heroData.map((item, idx) => (
              <Box key={idx} p={4} borderWidth="1px" borderRadius="md" mb={4}>
                ...
                <Textarea mt={2} placeholder="Banner Text" value={item.text} onChange={(e) => {
                  const updated = [...heroData];
                  updated[idx].text = e.target.value;
                  setHeroData(updated);
                }} />
                <Input mt={2} placeholder="Button Route" value={item.route} onChange={(e) => {
                  const updated = [...heroData];
            ...
            <Button colorScheme="blue" variant="solid">Update Hero Section</Button>
          </AccordionPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          <h2>
            <AccordionButton>
              <Box flex="1" textAlign="left" fontWeight="bold">Why SSTPL</Box>
              <AccordionIcon />
            </AccordionButton>
          </h2>
          <AccordionPanel>
            <Input type="file" onChange={(e) => setWhyData({ ...whyData, file: e.target.files[0] })} />
            <Textarea mt={2} placeholder="Why SSTPL Text" value={whyData.text} onChange={(e) => setWhyData({ ...whyData, text: e.target.value })} />
            <Button mt={4} colorScheme="blue">Update Why SSTPL</Button>
          </AccordionPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          <h2>
            <AccordionButton>
              <Box flex="1" textAlign="left" fontWeight="bold">Learn Section (3 Images)</Box>
              <AccordionIcon />
            </AccordionButton>
          </h2>
          <AccordionPanel>
            {learnData.map((item, idx) => (
              <Box key={idx} p={4} borderWidth="1px" borderRadius="md" mb={4}>
                ...
                <Textarea mt={2} placeholder="Text Content" value={item.text} onChange={(e) => {
        ...
        <AccordionItem>
          <h2>
            <AccordionButton>
              <Box flex="1" textAlign="left" fontWeight="bold">Clients Logos</Box>
              <AccordionIcon />
            </AccordionButton>
          </h2>
          <AccordionPanel>
            <VStack spacing={4}>
              ...
              <Button colorScheme="blue" mt={2}>Update Logos</Button>
            </VStack>
          </AccordionPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          <h2>
            <AccordionButton>
              <Box flex="1" textAlign="left" fontWeight="bold">Blogs (3 Posts)</Box>
              <AccordionIcon />
            </AccordionButton>
          </h2>
          <AccordionPanel>
            {blogData.map((blog, idx) => (
              <Box key={idx} p={4} borderWidth="1px" borderRadius="md" mb={4}>
                ...
                <Input mt={2} placeholder="Blog Title" value={blog.title} onChange={(e) => {
                  const updated = [...blogData];
                  updated[idx].title = e.target.value;
                  setBlogData(updated);
                }} />
                <Textarea mt={2} placeholder="Excerpt" value={blog.excerpt} onChange={(e) => {
                  const updated = [...blogData];
